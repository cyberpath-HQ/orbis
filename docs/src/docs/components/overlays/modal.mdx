    ...
    "children": [
      {
        ...
        "variant": "outline",
        "events": {
          "onClick": [{ "type": "update_state", "path": "isModalOpen", "value": false }]
        }
      },
      {
        "type": "Button",
...
```json
{
  ...
  "variant": "destructive",
  "events": {
    "onClick": [{ "type": "update_state", "path": "deleteModalOpen", "value": true }]
  }
}
```
</CodeBlock>
    ...
    "children": [
      {
        ...
        "variant": "outline",
        "events": {
          "onClick": [{ "type": "update_state", "path": "deleteModalOpen", "value": false }]
        }
      },
      {
        "type": "Button",
    ...
    "children": [
      {
        ...
        "variant": "ghost",
        "events": {
          "onClick": [{ "type": "update_state", "path": "showEditModal", "value": false }]
        }
      },
      {
        "type": "Button",
  ...
  "content": {
    ...
    "children": [
      { "type": "List", "dataSource": "state:items" },
      {
        ...
        "label": "Create New",
        "events": {
          "onClick": [{ "type": "update_state", "path": "level2Open", "value": true }]
        }
      }
    ]
  }
