...
```json
{
  ...
  "events": {
    "on_close": [{ "type": "update_state", "path": "isModalOpen", "value": false }]
  }
}
```
</CodeBlock>
...
```json
{
  ...
  "events": {
    "on_close": [{ "type": "update_state", "path": "deleteModalOpen", "value": false }]
  }
}
```
</CodeBlock>
...
```json
{
  ...
  "events": {
    "on_close": [{ "type": "update_state", "path": "showEditModal", "value": false }]
  }
}
```
</CodeBlock>
...
```json
{
  ...
  "events": {
    "on_close": [{ "type": "update_state", "path": "previewOpen", "value": false }]
  }
}
```
</CodeBlock>
...
```json
{
  ...
  "content": { "type": "Form", "..." },
  "events": {
    "on_close": [{ "type": "update_state", "path": "level2Open", "value": false }]
  }
}
```
</CodeBlock>
