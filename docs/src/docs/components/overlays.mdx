...
```json
{
    ...
    "children": [
      {
        ...
        "variant": "outline",
        "events": {
          "on_click": [{ "type": "closeDialog", "dialogId": "confirm-modal" }]
        }
      },
      {
        "type": "Button",
        ...
        "events": {
          "on_click": [
            ...
            { "type": "closeDialog", "dialogId": "confirm-modal" }
          ]
        }
      }
    ]
  ...
  "events": {
    "onClose": [{ "type": "updateState", "path": "modalData", "value": null }]
  }
}
```
</CodeBlock>
...
Use the `showDialog` action to open a modal:
...
```json
{
  ...
  "events": {
    "on_click": [
      { "type": "showDialog", "dialogId": "my-modal" }
    ]
  }
}
```
...
```json
{
  ...
  "events": {
    "on_click": [
      { "type": "closeDialog", "dialogId": "my-modal" }
    ]
  }
}
```
...
```json
{
  ...
  "events": {
    "on_click": [
      { "type": "showDialog", "dialogId": "delete-modal" }
    ]
  }
}
```
    ...
    "children": [
      {
        ...
        "variant": "outline",
        "events": {
          "on_click": [{ "type": "closeDialog", "dialogId": "delete-modal" }]
        }
      },
      {
        "type": "Button",
        ...
        "events": {
          "on_click": [
            { "type": "callApi", "api": "deleteItem", "body": { "id": "{{state.itemToDelete.id}}" } },
            { "type": "closeDialog", "dialogId": "delete-modal" },
...
```json
{
  ...
  "content": {
    ...
    "events": {
      "onSubmit": [
        { "type": "callApi", "api": "updateProfile", "body": "{{state.editForm}}" },
        { "type": "closeDialog", "dialogId": "edit-profile-modal" },
        { "type": "showToast", "message": "Profile updated", "level": "success" }
      ]
    }
  }
}
  ...
  "content": {
    ...
    "children": [
      { "type": "List", "dataSource": "state:items" },
      {
        ...
        "events": {
          "on_click": [
            { "type": "showDialog", "dialogId": "create-item-modal" }
          ]
        }
      }
    ]
...
```json
{
  ...
  "content": {
    ...
    "events": {
      "onSubmit": [
        { "type": "callApi", "api": "createItem", "body": "{{state.newItem}}" },
        { "type": "closeDialog", "dialogId": "create-item-modal" },
        { "type": "closeDialog", "dialogId": "select-item-modal" }
      ]
    }
  }
}
    ...
    "on_click": [
      {
        ...
        "then": [
          { "type": "showDialog", "dialogId": "confirm-delete-all" }
        ],
        "elseActions": [
          { "type": "showToast", "message": "No items to delete", "level": "info" }
        ]
      }
    ]
  }
