...
> **Last Auto-Update**: This table is refreshed daily via GitHub Actions. Updates are submitted as pull requests for review.

> **Note**: Changes to this table are automatically generated and submitted as pull requests to respect repository branch protection rules. Review and merge the PRs to keep the roadmap current.

{/* AUTO-GENERATED-TABLE-START */}
{/* This section is automatically updated by .github/workflows/update-roadmap.yml */}
{/* Do not manually edit between these comments */}

| Priority | Feature | Status | Issues / PRs |
| --- | --- | --- | --- |
| **High** | Publish `orbis-plugin-api` to crates.io | Planned | [Search](https://github.com/cyberpath-HQ/orbis/issues?q=crates.io+plugin-api) |
| **High** | Deploy docs to GitHub Pages | Planned | [Search](https://github.com/cyberpath-HQ/orbis/issues?q=docs+github+pages) |
...
| **High** | Pest-based DSL for Page Definitions | Planned | [Search](https://github.com/cyberpath-HQ/orbis/issues?q=pest+dsl+schema) |
| **High** | Plugin Metadata DSL | Planned | [Search](https://github.com/cyberpath-HQ/orbis/issues?q=metadata+dsl) |
...
| **Medium** | Complete Missing Documentation | Planned | [Search](https://github.com/cyberpath-HQ/orbis/issues?q=docs+missing) |
