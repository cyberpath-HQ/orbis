...
Ensure you have completed the [Installation](./installation) guide and have the Orbis development environment set up.
...
Navigate to the "Getting Started" page in the sidebar. You should see:
...
The `wrap_handler!` macros eliminates manual FFI:
<CodeBlock lang="rust">
```rust
...
### SDK Features
- **[Database Access](../../plugin-development/wasm-plugins#database---query-and-execute)** - Query and execute SQL
- **[HTTP Requests](../../plugin-development/wasm-plugins#http---external-api-calls)** - Make external API calls
- **[Logging](../../plugin-development/wasm-plugins#logging)** - Debug and monitoring
- **[Permissions](../../plugin-development/wasm-plugins#available-permissions)** - Security and access control
