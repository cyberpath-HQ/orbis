...
The plugin system - **most important for plugin developers**:
...
:::tip Key File for UI Development
`crates/orbis-plugin/src/ui.rs` is the **source of truth** for all UI component types. When adding new components, start here.
:::
...
│   ├── renderer.tsx       # **Schema Renderer (1600+ lines)**
...
:::tip Key Files for Frontend Development
